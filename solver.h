...
std::pair<double, double> HeunScheme(double xn, double v1, double v2, func1 f1, func2 f2, double h, double r)
{
    ...
    double k1 = f1(xn, v1 + r * dist(RNG) + h * f1(xn, v1, v2), v2 + r * dist(RNG) + h * f2(xn, v1, v2));
    double k2 = f2(xn, v1 + r * dist(RNG) + h * f1(xn, v1, v2), v2 + r * dist(RNG) + h * f2(xn, v1, v2));

    v1 += r * dist(RNG) + h * (f1(xn, v1, v2) + k1) / 2.0;
    v2 += r * dist(RNG) + h * (f2(xn, v1, v2) + k2) / 2.0;
